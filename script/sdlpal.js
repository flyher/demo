...
var wasmBinaryFile = '../wasm/sdlpal.wasm';
...
function _emscripten_glGetUniformLocation(program, name) {
  ...
  if (name[name.length - 1] == ']') {
    ...
    arrayIndex =
      name[leftBrace + 1] != ']' ? parseInt(name.slice(leftBrace + 1)) : 0; // "index]", parseInt will ignore the ']' at the end; but treat "foo[]" as "foo[0]"
...
if (!Object.getOwnPropertyDescriptor(Module, 'Asyncify__deps'))
  Module['Asyncify__deps'] = function () {
    abort(
      "'Asyncify__deps' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)"
    );
  };
...
if (!Object.getOwnPropertyDescriptor(Module, 'Fibers__deps'))
  Module['Fibers__deps'] = function () {
    abort(
      "'Fibers__deps' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)"
    );
  };
...
if (!Object.getOwnPropertyDescriptor(Module, 'IDBFS__deps'))
  Module['IDBFS__deps'] = function () {
    abort(
      "'IDBFS__deps' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)"
    );
  };
if (!Object.getOwnPropertyDescriptor(Module, 'IDBFS'))
  Module['IDBFS'] = function () {
    abort(
      "'IDBFS' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)"
    );
  };
    ...
    var post = function (msg) {
      ...
      http.onreadystatechange = function () {
        if (http.readyState == 4 /*DONE*/) {
          if (
            --emrun_num_post_messages_in_flight == 0 &&
